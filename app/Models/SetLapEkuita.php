...
class SetLapEkuita extends Model {
    //use RecordSignature;

    public $guarded = ["id","created_at","updated_at"];
    protected $table="set_lap_ekuitas";
    public $timestamps=true;
    protected $primaryKey = "id";
    public $incrementing = true;
    public static function findRequested()
    {
        $query = SetLapEkuita::query();
        ...
        \Request::input('jenis_data') and $query->where('jenis_data','like','%'.\Request::input('jenis_data').'%');
