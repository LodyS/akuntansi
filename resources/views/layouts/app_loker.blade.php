...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('admin_remark_base/') }}/assets/skins/green.css">
...
.cancel.btn-default{
  ...
  <body class="animsition dashboard">
    ...
    <![endif]-->
    @include('layouts.inc.header_pelamar')
    <!-- Page -->
    <div class="page">
