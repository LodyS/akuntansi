...
<div class="page-header">
    ...
    <div class="page-header-actions">
        <a class="btn btn-block btn-primary data-modal" id="data-modal" href="#" onclick="show_modal('{{ route('kategori-barang.create') }}')" >Tambah</a>
    </div>
</div>
    ...
    <div class="panel">
       <header class="panel-heading">
        ...
        <table class="table table-hover dataTable table-striped w-full" id="kategori-barang-table">
            <thead>
                <tr>
                    <th>No</th>
...
$(function() {
    $('.trash-ck').click(function(){
        ...
        document.location = '{{ url("kategori-barang?status=trash") }}';
    } else {
        document.location = '{{ url("kategori-barang") }}';
    }
});

const table = $('#kategori-barang-table').DataTable({
    stateSave: true,
    processing : true,
    serverSide : true,
    searching : false,
    pageLength:20,
        ajax : {
                url:"{{ url('kategori-barang/load-data') }}",
                data: function (d) {
        ...
        { data: 'nama', name: 'nama' },
        { data: 'coa_persediaan', name: 'coa_persediaan' },
