...
<div class="page-content">
    <div class="panel">
        ...
        <form action="{{ url('/simpan-jurnal-mutasi-pengeluaran-kas')}}" method="post">{{ @csrf_field() }}
        ...
        @php ($total_kredit=0)
            ...
            <tr>
                ...
                <button type="submit" align="right" class="btn btn-primary"><i class="icon glyphicon glyphicon-save" aria-hidden="true">
                </i>Simpan</button>
             </form>
        </div>
    </div>
