...
@section('content')
   <div class="page-header">
     ...
     <a class="btn btn-block btn-primary data-modal" id="data-modal" href="#" onclick="show_modal('{{ route('arus-ka.create') }}')" >Tambah</a>
     </div>
   </div>
...
$(function() {
  $('.trash-ck').click(function(){
    if ($('.trash-ck').prop('checked')) {
      document.location = '{{ url("arus-ka?status=trash") }}';
    } else {
      document.location = '{{ url("arus-ka") }}';
    }
  });
