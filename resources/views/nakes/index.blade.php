...
<div class="page-header">
    <h1 class="page-title">Nakes</h1>
    @include('layouts.inc.breadcrumb')
    <div class="page-header-actions">
        <a class="btn btn-block btn-primary data-modal" id="data-modal" href="#"
            onclick="show_modal('{{ route('nakes.create') }}')">Tambah</a>
    </div>
</div>
<div class="page-content">
    <div class="panel">
        ...
        <button type="button" id="submit" align="right" class="btn btn-primary">Cari</button><br/><br/>
            <table class="table table-hover dataTable table-striped w-full" id="nakes-table">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Kode Nakes</th>
...
<script type="text/javascript">
    $(function() {
        const table = $('#nakes-table').DataTable({
            stateSave: true,
            processing : true,
            serverSide : true,
            pageLength:20,
