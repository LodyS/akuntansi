            ...
            <table class="table table-hover aktiva" id="aktiva">
                ...
                <tbody>
                    ...
                    <tr style="font-weight: {{ $a->total > 0 ? 'bold' : 'normal' }}">
                        ...
                        <td class="text-nowrap text-right">{{ ($nominal  !==0) ? nominalTitik($a->saldo + $a->total, false) : '' }}</td>
                    </tr>
                ...
                @endif
                            ...
                            <table class="table table-hover passiva" id="passiva">
                                ...
                                @forelse($passiva as $pass)
                                    <tr style="font-weight: {{ $pass->total_passiva > 0 ? 'bold' : 'normal' }}">
                                        <td>{{ $pass->passiva}}</td>
                                        <td class="text-nowrap text-right">{{ ($pass->total !== null) ? nominalTitik($pass->total_passiva) : '' }}</td>
                                    </tr>
                                    @empty
                                    <tr>
                                        <td></td>
                        ...
                        <button id="ExporttoExcel" class="btn btn-success round" onclick="toExcel()" value="Export to Excel">Excel</button>
                    </div>
                </div>
            </div>
        </div>
