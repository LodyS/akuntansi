...
<div class="page-header">
	<h1 class="page-title">Setting COA Tarif Rawat Jalan</h1>
    <div class="page-header-actions">
       ...
       <div class="panel-body">
       		...
       		<input type="hidden" name="asal" value="RJ">
                ...
                <button type="submit" id="submit" align="right" class="btn btn-primary">Cari</button><br/>
            ...
            <form action="{{ url('/simpan-setting-tarif') }}" method="post" id="create">{{ @csrf_field() }} 
            	...
            	<input type="hidden" name="type" value="RJ">
					...
					<input type="hidden" name="status" value="{{ isset($status) ? 'Ada' : 'Kosong' }}">
            			...
            			<table class="table table-hover">
                			...
                			<tr>
                    			<input type="hidden" name="id_tarif[]" value="{{ $coa->id }}" required>
                    			<input type="hidden" name="id_kelas[]" value="{{ $coa->id_kelas }}" required>
                    			<td>{{ $i }}</td>
