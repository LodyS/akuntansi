...
<div class="page-header">
    <h1 class="page-title">Arus Kas Detail</h1>
...
$(function() {
    $('.trash-ck').click(function(){
        if ($('.trash-ck').prop('checked')) {
            document.location = '{{ url("arus-kas-detail?status=trash") }}';
        } else {
            document.location = '{{ url("arus-kas-detail") }}';
        }
  });
    ...
    $('#arus-ka-table').DataTable({
        ...
        pageLength:20,
            ...
            ajax : {
                url:"{{ url('arus-kas-detail/load-data') }}",
                    data: function (d) {
