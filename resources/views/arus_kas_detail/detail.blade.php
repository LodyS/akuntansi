...
<div class="page-header">
    ...
    <div class="page-header-actions">
     <a class="btn btn-block btn-primary" href="{{ url('arus-kas-detail/form', $id) }}">Tambah</a>
    </div>
</div>
            ...
            <table class="table table-hover dataTable table-striped w-full" id="detail-set-neraca-detail-table">
                <thead>
                    ...
                    <tr>
                        ...
                        <td>{{ $data->kode }}</td>
                        <td>{{ $data->nama }}</td>
                        <td><a href="{{ url('arus-kas-detail/edit', $data->id) }}" class="btn btn-xs btn-success">Edit</a>
 ...
 <div class="modal inmodal fade" id="modal-delete" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xs">
        <form name="frm_delete" id="frm_delete" class="form-horizontal" action="{{route('remove-arus-kas')}}" method="POST">@csrf
...
$(document).ready(function() {
    ...
    $('.delete').on("click",function() {
        ...
        $.ajax({
            url : "{{route('delete-arus-kas')}}?id="+id,
            type: "GET",
            dataType: "JSON",
