...
<div class="page-content">
    <div class="panel">
        ...
        <h3 align="center">Tambah Setting Perubahan Ekuitas</h3><br/>
        <form action="{{ url('simpan-perubahan-ekuitas') }}" method="post">{{ @csrf_field() }}

        	<input type="hidden" name="id_set_lap_ekuitas" value="{{ $id }}">
