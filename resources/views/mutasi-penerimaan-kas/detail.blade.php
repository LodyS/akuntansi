	            ...
	            <form action="{{ url('/simpan-mutasi-penerimaan-kas')  }}" method="post">{{ @csrf_field() }}
                    ...
                    <div class="form-group row">
			            <label class="col-md-3">Jenis Penerimaan Kas</label>
				            <div class="col-md-7">
                            <input type="text" class="form-control btn-round" value="{{ isset($mutasiKas) ? $mutasiKas->induk : ''}}" readonly>
			            </div>
		            </div>
		            ...
		            <div class="form-group row">
			            <label class="col-md-3">Sub Jenis Penerimaan Kas</label>
				            <div class="col-md-7">
                            <input type="text" class="form-control btn-round" readonly value="{{isset($mutasiKas) ? $mutasiKas->arus_kas : ''}}">
			            </div>
		            </div>
                    ...
                    <div class="form-group row">
			            <label class="col-md-3">Tanggal</label>
				            <div class="col-md-7">
				            <input type="date" value="{{ isset($mutasiKas) ? $mutasiKas->tanggal : '' }}" class="form-control btn-round" readonly>
			            </div>
		            </div>
                    ...
                    <div class="form-group row">
                        <label class="col-md-3">Keterangan</label>
                            <div class="col-md-7">
                            <input type="text" class="form-control btn-round" value="{{ isset($mutasiKas) ? $mutasiKas->keterangan : '' }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
			            <label class="col-md-3">Penerimaan</label>
				            <div class="col-md-7">
                            <input type="text" class="form-control btn-round" readonly value="{{isset($mutasiKas) ? $mutasiKas->bank : ''}}">
			            </div>
		            </div>
                    ...
                    <div class="form-group row">
                        <label class="col-md-3">Total Nominal</label>
                            <div class="col-md-7">
                            <input type="text" class="form-control btn-round" readonly value="Rp. {{ isset($mutasiKas) ? number_format($mutasiKas->nominal) : '0'}}">
                        </div>
                    </div>
...
<div class="modal inmodal fade" id="modal-edit" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xs">
        <form name="frm_edit" id="frm_edit" class="form-horizontal" action="{{route('update-mutasi-penerimaan-kas')}}" method="POST">@csrf
            <div class="modal-content">
                <div class="modal-header">
                <h4 class="modal-title">Edit Mutasi Penerimaan Kas : <br/>
...
<div class="modal inmodal fade" id="modal-delete" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xs">
        <form name="frm_delete" id="frm_delete" class="form-horizontal" action="{{route('remove-mutasi-penerimaan-kas')}}" method="POST">@csrf
            <div class="modal-content">
                <div class="modal-header">
...
$(document).ready(function() {
    ...
    $('.edit').on("click",function() {
        ...
        //$("#get_id_bank").val(id)
        $.ajax({
            url : "{{route('edit-mutasi-penerimaan-kas')}}?id="+id,
            type: "GET",
            dataType: "JSON",
    ...
    $('.delete').on("click",function() {
        var id = $(this).attr('data-id');
        $.ajax({
            url : "{{route('delete-mutasi-penerimaan-kas')}}?id="+id,
            type: "GET",
            dataType: "JSON",
            success: function(data){
