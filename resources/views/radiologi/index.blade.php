...
<div class="page-header">
    <h1 class="page-title">Radiologi</h1>
    ...
    <div class="panel">
        <div class="panel-body">
            <div class="form-group row ml-10">
                <div class="col-md-2">
                    <input class="form-check-input" type="radio" name="radiologi" id="radiologi" value="radiologi"
                        checked onclick="window.location='{{ route("radiologi.index") }}'">
                ...
                <div class="col-md-2">
                    <input class="form-check-input" type="radio" name="golongan_radiologi" id="golongan_radiologi"
                        value="golongan_radiologi"
                        onclick="window.location='{{ route("radiologi.golongan_radiologi") }}'">
            ...
            <!--<form name="formCari" action="" method="post">{{ @csrf_field() }}
...
<script type="text/javascript">
    $(function() {
        const table = $('#radiologi-table').DataTable({
            stateSave: true,
            processing : true,
            serverSide : true,
            pageLength:20,
            searching : false,
                ajax : {
                    url:"{{ url('radiologi/load-data') }}",
                    /*data: function (d) {
                        const form = document.forms.namedItem("formCari");
                        d.layanan = form.layanan.value;
                        d.jenis = form.jenis.value;
                        d.golongan = form.golongan.value;
                    }*/
            },
            columns: [
