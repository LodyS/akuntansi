...
<div class="page-header">
    <h1 class="page-title">Jenis Radiologi</h1>
            ...
            <div class="form-group row ml-10">
                ...
                <div class="col-md-2">
                    <input class="form-check-input" type="radio" name="jenis_radiologi" id="jenis_radiologi"
                        value="jenis_radiologi" checked onclick="window.location='{{ route("radiologi.jenis_radiologi") }}'">
                ...
                <div class="col-md-2">
                    <input class="form-check-input" type="radio" name="golongan_radiologi" id="golongan_radiologi"
                        value="golongan_radiologi" onclick="window.location='{{ route("radiologi.golongan_radiologi") }}'">
...
<script type="text/javascript">
    $(function() {
        $('#radiologi-table').DataTable({
            ...
            pageLength:20,
                ajax : {
                    url:"{{ url('radiologi/load-data-jenis-radiologi') }}",
                    data: function (d) {
