...
<div class="page-header">
    <h1 class="page-title">Jurnal Pengeluaran Kas</h1>
...
<div class="page-content">
    ...
    <div class="panel panel-bordered">
        <div class="panel-heading">
            <h3 class="panel-title">Data Pengeluaran Kas</h3>
    ...
    $(function () {
        ...
        $('.trash-ck').click(function () {
            if ($('.trash-ck').prop('checked')) {
                document.location = '{{ url("jurnal-pengeluaran-kas?status=trash") }}';
            } else {
                document.location = '{{ url("jurnal-pengeluaran-kas") }}';
            }
        });
        var table = $('#pengeluaran-kas-table').DataTable({
            ...
            pageLength: 20,
            ajax: {
                url: "{{ url('jurnal-pengeluaran-kas/load-data') }}",
                data: function ( d ) {
                    return $.extend( {}, d, {
        ...
        $('#btnCreateJurnal').click(function(){
            ...
            // alert(tgl);
            location.href = "{{ url('jurnal-pengeluaran-kas/create-jurnal') }}/" + tgl;
        });
    });
</script>
@endpush
