...
<div class="page-header">
    <h1 class="page-title">Form Jurnal Pengeluaran Kas</h1>
...
<div class="page-content">
    <form id="form-jurnal-pengeluaran-kas" action="{{ url('jurnal-pengeluaran-kas/store-jurnal') }}" method="post">
    {{ @csrf_field() }}
        ...
        <div class="panel panel-bordered">
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm">
                                <input type="date" class="form-control" id="kode_jurnal" name="tanggal" value="{{ $tgl }}">
                            </div>
                        </div>
                ...
                <hr>
                <table class="table table-hover dataTable table-striped w-full" id="jurnal-pengeluaran-kas-table">
                    <thead>
                        <tr>
                            <th>No</th>
...
<script type="text/javascript">
    $(function () {
       ...
       /* var table = $('#jurnal-pengeluaran-kas-table').DataTable({
            paging: false,
            searching: false,
            info: false,
            data: <?= $data; ?>,
        ...
        $('#form-jurnal-pengeluaran-kas').formValidation({
