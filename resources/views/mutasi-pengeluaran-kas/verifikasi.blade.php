...
<div class="page-header">
    <h1 class="page-title">Jurnal Mutasi Pengeluaran Kas</h1>
</div>
...
<div class="page-content">
    <div class="panel">
        ...
        <form action="{{ url('/verifikasi-mutasi-pengeluaran-kas')}}" method="post">{{ @csrf_field() }}
            <input type="hidden" name="id_mutasi_kas" value="{{$id }}">
                <div class="form-group row">
		            <label class="col-md-3">Kode Jurnal</label>
			            <div class="col-md-7">
                        <input type="text" name="kode_jurnal" value="{{ isset($kode) ? $kode->kode : 'GJ-1' }}" class="form-control round" readonly>
		            </div>
	            </div>
                ...
                <div class="form-group row">
		            <label class="col-md-3">Tanggal</label>
			            <div class="col-md-7">
			            <input type="date" name="tanggal" value="{{ isset($tanggal) ? $tanggal->tanggal : date('Y-m-d') }}" class="form-control round" readonly>
		            </div>
	            </div>
        ...
        @php ($total_kredit=0)
            ...
            <tr>
                ...
                <button type="submit" align="right" class="btn btn-primary btn-round"> <i class="icon glyphicon glyphicon-save" aria-hidden="true"></i>Simpan</button>
             </form>
        </div>
    </div>
</div>
